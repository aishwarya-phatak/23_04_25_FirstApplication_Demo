...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        welcomeLabel = UILabel(frame: welcomeLabelRect)
        ...
        messageLabel = UILabel(frame: messageLabelRect)
        ...
        nameTextField = UITextField(frame: nameTextFieldRect)
        ...
        submitButton = UIButton(frame: submitButtonRect)
